	...
	'src/tasks/data/validators.js'(exports) {
		...
		function validate12(data, { instancePath = '', parentData, parentDataProperty, rootData = data } = {}) {
			...
			if (errors === 0) {
				if (data && typeof data == 'object' && !Array.isArray(data)) {
					let missing0;
					if ((data.source === void 0 && (missing0 = 'source')) || (data.sentences === void 0 && (missing0 = 'sentences'))) {
						validate12.errors = [
							{
								instancePath,
								schemaPath: '#/required',
								...
								for (let i0 = 0; i0 < len0; i0++) {
									...
									if (errors === _errs14) {
										if (data5 && typeof data5 == 'object' && !Array.isArray(data5)) {
											let missing2;
											if ((data5.role === void 0 && (missing2 = 'role')) || (data5.content === void 0 && (missing2 = 'content'))) {
												const err7 = {
